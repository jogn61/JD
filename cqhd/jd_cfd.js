...
!(async () => {
  ...
  await requestAlgo();
  let res = {}, res2 = await getAuthorShareCode("https://raw.githubusercontent.com/ElsaKing/updateTeam/main/shareCodes/cfd.json")
  if (new Date().getHours() <= 3) res = await getAuthorShareCode('https://ghproxy.com/https://raw.githubusercontent.com/ElsaKing/updateTeam/main/shareCodes/cfd.json');
  if (!res2) res2 = await getAuthorShareCode('https://ghproxy.com/https://raw.githubusercontent.com/ElsaKing/updateTeam/main/shareCodes/cfd.json')
...
function shareCodesFormat() {
  return new Promise(async resolve => {
    ...
    if ($.shareCodesArr[$.index - 1]) {
      ...
      $.newShareCodes = [...$.strMyShareIds, "0C1CAFA71BFB80DFD6FDFBC46D76F762437A40CA0AACBBB44421BD247F623228"];
    }
